...
public class ConsoleApp {
    ...
    public static String playerName = " Jack ";
    ...
    public static  void main(String[] args) {
        ...
        while (true) {
            ...
            if (!isEnemyExist()) {
                playerExp++;
                System.out.println(playerName + " is win. Count coins = " + playerCoins + ". Your new level is = "+ playerExp);
                break;
            }
    ...
    public static void playerMoveAction() {
        ...
        do {
            ...
            System.out.println("Enter destination: (UP-" + playerMoveUp + "|Down-" + playerMoveDown + "|LEFT-" + playerMoveLeft + "|RIGHT-" + playerMoveRight + ") >");
